...
CREATE TABLE CUSTOMER(
    ...
    AGE NUMBER CONSTRAINT CHK_CUSTOMER_AGE CHECK (AGE BETWEEN 0 AND 100),
...
-- 2. 칼럼 수정 : ALTER TABLE MODIFY 칼럼명 데이터타입 [제약조건]
-- 3. 칼럼 삭제 : ALTER TABLE DROP COLUMN 칼럼명
-- 4. 칼럼 이름 : ALTER TABLE RENAME COLUMN OLD이름 TO NEW 이름
