...
ALTER TABLE BUYS
    DISABLE CONSTRAINT FK_BUYS_USERS;    
    
ALTER TABLE USERS
    DISABLE CONSTRAINT PK_USERS;
...
ALTER TABLE USERS
    ENABLE CONSTRAINT PK_USERS;
ALTER TABLE BUYS
    ENABLE CONSTRAINT FK_BUYS_USERS;
...
-- KYM     1
-- LHJ     2
SELECT USER_ID, COUNT(BUY_AMOUNT)
  FROM BUYS
 GROUP BY USER_ID;
...
-- KHD     강호동  3         1210
-- PSH     박수홍  3         1860
SELECT B.USER.ID, U.USER_NAME
  FROM USERS U, BUYS B, PRODUCT P
