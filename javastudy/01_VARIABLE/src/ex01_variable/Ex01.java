...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		// 논리 타입 (변수명을 지을 때 is로 시작하는 관습이 있음)
		boolean isGood = true;
		...
		// 정수 타입
		int score = 100;
		// int point = 3000000000L;
		long view = 10000000000L; // long 타입의 값은 마지막에 L 또는 l을 추가해야 함. (값의 메모리는 int 타입이라서)
