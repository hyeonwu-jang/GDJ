...
//		}
	...
	public static void m2() {
		...
		// {"response":{"header":{"resultCode":"03","resultMsg":"NODATA_ERROR"}}} 파싱
		// {"프로퍼티":값} == {property:value} 형식
		...
		String api1Source = sb.toString();
		
		JSONObject obj = new JSONObject(api1Source);		// JSONObject(String source) 이용하려면 String으로 변환 필요.
		JSONObject obj2 = obj.getJSONObject("response");
		JSONObject obj3 = obj2.getJSONObject("header");
		String resultCode = obj3.getString("resultCode");	// 객체 3개 존재 -> 이후 프로퍼티는 객체가 아니라 String 데이터타입으로 파싱
	...
	public static void m6() {	
		...
		Map<String, Object> map = new HashMap<String, Object>();	// Map = <key> 값을 입력하여 <value> 값을 찾는다.
