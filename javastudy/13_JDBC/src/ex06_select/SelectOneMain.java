...
public class SelectOneMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 조회 결과 1개인 경우
			// rs.next() 메소드 호출은 1번!
			if(rs.next()) { // 스캔 성공하면(조회 결과가 있으면) ==> 결과값이 단일행이라서 if 사용
				...
				*/
				...
				// 확인
				System.out.println(board);  // Board 클래스의 toString() 메소드 동작 ==> domain에서 toString 메소드가 있어야 출력 가능
