...
public class ReExam {
	...
	public static void q5() {
		...
		System.out.println(month + "월은 " + lastDay[month] + "일까지 있고, " + season[((month % 12) / 3)] + "입니다.");
	}
	...
	public static void q6() {
		...
		// System.out.println(((second/60) <= 60) ? second + "초" : ((second/60) > 60) ? (second/60) + "분" + second + "초" : ((second / 60) > 3600) ? (second / 3600) + "시" + 
