...
public class TextServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// 응답													// MIME-TYPE : text/html, text/plain, application/xml, application/json 등
			response.setContentType("text/plain; charset=UTF-8");	// 단순 텍스트의 MIME-TYPE (dataType: 'text'는 text/plain으로 설정)
